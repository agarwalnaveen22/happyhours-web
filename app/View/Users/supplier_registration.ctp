                                        ...
                                        <div class="content-box-wrapper">
                                            <div class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6 col-md-5 diff-color">
                                            ...
                                            <div class="step_3_content">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-6">
                                                        <div class="three_btn_group marg-top-20">
                                                            <input type="hidden" id='supplierDeclareId' name="data[SupplierDetail][id]" value="" />
                                                            <button type="submit" class="ph_btn_midium btn hvr-pop marg-none hvr-rectangle-out1 btn-black">Back</button>
                                                            <button type="submit" class="btn ph_btn_midium marg-left-10 btn-info hvr-pop hvr-rectangle-out">Next</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="content-box-wrapper">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12">
                                                    <p class="tip_wizard">It is advise to upload your documents in PDF Format</p></div></div>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6">
                                                    <section class="step4_form">
                                                        ...
                                                        <div class="other_attachemts">
                                                            ...
                                                            <div class="three_btn_group">
                                                                ...
                                                                <button type="submit" class="btn ph_btn_midium hvr-pop marg-none hvr-rectangle-out1 btn-black">Back</button>
                                                                <button type="submit" class="btn marg-left-10 ph_btn_midium btn-info hvr-pop hvr-rectangle-out">Finish</button>
                                                            </div>
                                                        </div>
                                                    </section>
                                                </div>
...
<!-- Theme layout -->
<script type="text/javascript" src="<?php echo Configure::read('App.baseUrl'); ?>/css/assets/themes/admin/registration-page.js"></script>
