                                                ...
                                                <div class="content-box-wrapper">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6 col-md-5">
                                                                <input type="text" class="form-control" <?php echo ($this->Session->read("Auth.User")['User']['role_id']==2)?"disabled":""; ?> name="data[SupplierDetail][company_registration_number]" value="<?php echo $supplierData['SupplierDetail']['company_registration_number'] ?>" required placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <section id="company-pro">
                                                                ...
                                                                <div data-provides="fileinput" class="fileinput fileinput-new input-group">
                                                                    ...
                                                                    <span class="input-group-addon btn btn-black btn-file"> <span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
                                                                        <input type="file" id="load_file" name="data[SupplierDocument][profile]">
                                                                    </span> <a data-dismiss="fileinput" class="input-group-addon btn btn-default fileinput-exists" href="#">Remove</a> 
                                                                ...
                                                                <div class="other_attachemts">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <button class="btn btn-info hvr-pop marg-top-10 hvr-rectangle-out width-75" onclick="fileUpload()" type="button">Upload</button>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <textarea class="form-control width-75" rows="3" name="data[SupplierDetail][document_description]" placeholder="Description"><?php echo $supplierData['SupplierDetail']['document_description']; ?></textarea>
                                                                    </div>
                                                                    ...
                                                                    <div class="three_btn_group">
                                                                        ...
                                                                        <button type="submit" class="btn hvr-pop ph_btn_midium marg-none hvr-rectangle-out1 btn-black">Back</button>
                                                                        <button type="submit" class="btn btn-info marg-left-10 ph_btn_midium hvr-pop hvr-rectangle-out">Finish</button>
                                                                    </div>
                                                                </div>
                                                            </section>
                                                        </div>
