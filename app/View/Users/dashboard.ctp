          ...
          <div class="widget widget-shadow">
            <div class="widget-content text-center bg-white padding-40">
              <div class="avatar avatar-100 margin-bottom-20">
                <img src="<?php echo Configure::read('App.baseUrl'); ?>/global/portraits/1.jpg" alt="">
              </div>
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-online" href="javascript:void(0)">
                        <img src="<?php echo Configure::read('App.baseUrl'); ?>/global/portraits/9.jpg" alt="">
                        <i></i>
                      </a>
                    </div>
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-away" href="javascript:void(0)">
                        <img src="<?php echo Configure::read('App.baseUrl'); ?>/global/portraits/10.jpg" alt="">
                        <i></i>
                      </a>
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-busy" href="javascript:void(0)">
                        <img src="<?php echo Configure::read('App.baseUrl'); ?>/global/portraits/11.jpg" alt="">
                        <i></i>
                      </a>
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a class="avatar avatar-off" href="javascript:void(0)">
                        <img src="<?php echo Configure::read('App.baseUrl'); ?>/global/portraits/12.jpg" alt="">
                        <i></i>
                      </a>
                    </div>
                    <div class="media-body">
              ...
              <ul class="list-group list-group-dividered list-group-full">
                <li class="list-group-item">
                  ...
                  <small>Opened by
                    ...
                    <time datetime="2016-07-01T08:55">2 hours ago</time>
                  </small>
                </li>
                <li class="list-group-item">
                  ...
                  <small>Opened by
                    ...
                    <time datetime="2016-07-01T07:55">1 hour ago</time>
                  </small>
                </li>
                <li class="list-group-item">
                  ...
                  <small>Opened by
                    ...
                    <time datetime="2016-06-28T21:05">3 days ago</time>
                  </small>
                </li>
                <li class="list-group-item">
                  ...
                  <small>Opened by
                    ...
                    <time datetime="2016-06-27T13:05">4 days ago</time>
                  </small>
                </li>
              </ul>
            </div>
