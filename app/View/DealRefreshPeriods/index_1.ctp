    ...
    <div id="page-content">
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Deal Refresh Period</li>
            </ol>
                ...
                <div class="tab-pane active">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active marg-bottom-15" id="step-1">
                            <?php if ($isPermit) { ?>
                                <form method="post" id="supplier-product-category" onsubmit="return saveDealRefreshPeriod()">
                                    <div class="upload_download_wrapper clearfix mar-t20 event_info">
                                        <h4>Deal Refresh Period Details</h4>
                                        <div class="row">
