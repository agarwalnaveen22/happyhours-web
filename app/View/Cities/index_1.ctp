                ...
                <div class="tab-pane active">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active marg-bottom-15" id="step-1">
                            <?php if ($isPermit) { ?>
                                <form method="post" id="supplier-product-category" onsubmit="return saveCity()">
                                        ...
                                        <div class="row">
                                            <div class="form-tander1 pad_all_15">
                                                ...
                                                <div class="col-sm-5 col-md-5 col-xs-6 col-xs-6">
                                                    <select name="data[City][country_id]" onchange="getStates(this.value)"  required class="custom-select country_id">
                                            ...
                                            <div class="form-tander1 pad_all_15">
                                                ...
                                                <div class="col-sm-5 col-md-5 col-xs-6 col-xs-6">
                                                    <select name="data[City][state_id]"  required class="custom-select state_id">
